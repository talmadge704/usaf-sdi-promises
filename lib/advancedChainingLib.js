...
var clarifaiApp = new Clarifai.App({
  apiKey:'225790b6441148cb9524b076aabf97dd'
});
/*
...
var predictImage = function (imageUrl) {
  if (clarifaiApp._config.apiKey === 'YOUR API KEY HERE') {
    throw new Error('You must add your API key before you can predict an image. : ', clarifaiApp._config.apiKey);
  }
